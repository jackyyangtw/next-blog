...
export default function BookmarkCard({ bookmark }: { bookmark: BookmarkDoc }) {
  ...
  const bannerSrc = getPostBannerImageSrc(post, { width: 600, height: 600 });
        ...
        <Grid container spacing={2}>
          <Grid size={3}>
            {bannerSrc ? (
              ...
              <Box
                sx={{ bgcolor: "grey.200", width: "100%", height: "100%" }}
              />
            )}
          </Grid>
            ...
            <Stack direction="column" spacing={1} sx={{ p: 2 }}>
              ...
              >
                <Avatar
                  src={
                    post.author?.avatar
                      ? urlFor(post.author.avatar).width(100).height(100).url()
                      : ""
                  }
